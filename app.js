...
class StudentInfoSystem {
    ...
    initEventListeners() {
        ...
        this.darkModeToggle.addEventListener('change', () => {
            // This would implement dark mode in a real application
            this.showNotification('Dark mode setting saved!', 'success');
        });
    ...
    saveStudent() {
        ...
        const existingStudent = this.students.find(s =>
            ...
            (!this.editingId || s.id !== this.editingId)
        );
    ...
    renderStudentList() {
        ...
        document.querySelectorAll('.delete-btn').forEach(btn => {
            btn.addEventListener('click', () => {
                this.deleteStudent(parseInt(btn.dataset.id));
            });
        });
    }
    ...
    updateAnalytics() {
        ...
        gpaRanges.forEach(range => {
            const studentsInRange = this.students.filter(student =>
                student.gpa >= range.min && student.gpa <= range.max
            );
    ...
    loadFromLocalStorage() {
        ...
        if (currentIdData) {
            this.currentId = parseInt(currentIdData);
        }
    }
